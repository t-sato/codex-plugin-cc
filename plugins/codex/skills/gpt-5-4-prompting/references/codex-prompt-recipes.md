...
In `codex:codex-rescue`, run diagnosis and fix-oriented recipes in full-access write mode by default unless the user explicitly asked for read-only behavior.
